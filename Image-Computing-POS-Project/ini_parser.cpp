...
* @return true in case given directory exists
* @return false in case given directory doesn't exist
*/
	if (dir == NULL) {
...
* @return 1 in case given directories in .ini file exist, if not returns 0
*/
